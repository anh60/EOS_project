...
#define SET_POS_THREAD_STACK_SIZE       1024
#define SET_POS_THREAD_TIMESLICE        10
#define SET_POS_ACTION_PERIOD           (50 * TICKS_MS) //Should activate every 50 ms
//CALCULATE
#define CALCULATE_POS_THREAD_PRIORITY   2
#define CALCULATE_POS_THREAD_STACK_SIZE 1024
#define CALCULATE_POS_THREAD_TIMESLICE  10
